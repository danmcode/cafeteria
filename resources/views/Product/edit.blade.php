    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('productos.update', $product->id) }}" method="POST"
                        novalidate>
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="reference" type="text"
                                    ...
                                    value="{{ $product->reference }}" required autocomplete="reference" autofocus>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="weight" type="number"
                                    ...
                                    value="{{ $product->weight }}" required autocomplete="weight" autofocus>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="category" type="text"
                                    ...
                                    value="{{ $product->category }}" required autocomplete="weight" autofocus>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input id="stock" type="number"
                                    ...
                                    value="{{ $product->stock }}" required autocomplete="weight" autofocus>
                                <div class="invalid-feedback">
